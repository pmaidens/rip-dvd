CREATE TABLE `worker_incidents` (
	...
	CONSTRAINT "worker_incidents_reason_code_check" CHECK("reason_code" in ('poll_failure', 'publication_recovery_failure')),
	CONSTRAINT "worker_incidents_phase_check" CHECK("phase" in ('polling', 'publication_recovery')),
