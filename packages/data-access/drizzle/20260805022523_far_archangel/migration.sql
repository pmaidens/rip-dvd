ALTER TABLE `encode_jobs` ADD `replacement_output_identity` text;--> statement-breakpoint
ALTER TABLE `encode_jobs` ADD `partial_cleanup_output_path` text;--> statement-breakpoint
ALTER TABLE `encode_jobs` ADD `partial_cleanup_claim_token` text;--> statement-breakpoint
