ALTER TABLE `original_disc_archives` ADD `boundary_policy_version` text;--> statement-breakpoint
ALTER TABLE `original_disc_archives` ADD `boundary_reported_size_bytes` integer;--> statement-breakpoint
ALTER TABLE `original_disc_archives` ADD `boundary_published_size_bytes` integer;--> statement-breakpoint
ALTER TABLE `original_disc_archives` ADD `boundary_excluded_sector_count` integer;--> statement-breakpoint
...
CREATE TABLE `__new_original_disc_archives` (
	...
	CONSTRAINT "original_disc_archives_boundary_evidence_check" CHECK(("boundary_policy_version" is null and "boundary_reported_size_bytes" is null and "boundary_published_size_bytes" is null and "boundary_excluded_sector_count" is null) or ("disc_kind" = 'dvd' and typeof("boundary_policy_version") = 'text' and length("boundary_policy_version") between 1 and 128 and typeof("boundary_reported_size_bytes") = 'integer' and "boundary_reported_size_bytes" between 1 and 9000000000 and typeof("boundary_published_size_bytes") = 'integer' and "boundary_published_size_bytes" = "boundary_reported_size_bytes" and "boundary_published_size_bytes" = "size_bytes" and typeof("boundary_excluded_sector_count") = 'integer' and "boundary_excluded_sector_count" = 0)),
...
INSERT INTO `__new_original_disc_archives`(`id`, `detected_disc_id`, `disc_kind`, `archive_format`, `archive_path`, `fingerprint`, `size_bytes`, `integrity`, `integrity_policy_version`, `bad_sector_count`, `bad_area_count`, `bad_sector_ranges`, `bad_sector_counts_by_title`, `archived_at`, `catalog_reviewed_at`, `catalog_review_outcome`, `legacy_cutover_pending`, `verification_status`, `verification_message`, `verified_at`, `created_at`, `updated_at`) SELECT `id`, `detected_disc_id`, `disc_kind`, `archive_format`, `archive_path`, `fingerprint`, `size_bytes`, `integrity`, `integrity_policy_version`, `bad_sector_count`, `bad_area_count`, `bad_sector_ranges`, `bad_sector_counts_by_title`, `archived_at`, `catalog_reviewed_at`, `catalog_review_outcome`, `legacy_cutover_pending`, `verification_status`, `verification_message`, `verified_at`, `created_at`, `updated_at` FROM `original_disc_archives`;--> statement-breakpoint
