ALTER TABLE `encode_jobs` ADD `partial_cleanup_lease_token` text;--> statement-breakpoint
...
INSERT INTO `__new_encode_jobs`(`id`, `disc_selection_id`, `encoding_profile_id`, `output_path`, `reserves_output_path`, `status`, `priority`, `replace_existing_output`, `replacement_output_identity`, `partial_cleanup_output_path`, `partial_cleanup_claim_token`, `publication_pending`, `progress_phase`, `progress_percent`, `progress_eta_seconds`, `claimed_by`, `claim_token`, `claimed_at`, `started_at`, `completed_at`, `error_message`, `created_at`, `updated_at`) SELECT `id`, `disc_selection_id`, `encoding_profile_id`, `output_path`, `reserves_output_path`, `status`, `priority`, `replace_existing_output`, `replacement_output_identity`, `partial_cleanup_output_path`, `partial_cleanup_claim_token`, `publication_pending`, `progress_phase`, `progress_percent`, `progress_eta_seconds`, `claimed_by`, `claim_token`, `claimed_at`, `started_at`, `completed_at`, `error_message`, `created_at`, `updated_at` FROM `encode_jobs`;--> statement-breakpoint
