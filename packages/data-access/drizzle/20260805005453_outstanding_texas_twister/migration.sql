ALTER TABLE `encode_jobs` ADD `progress_phase` text;--> statement-breakpoint
ALTER TABLE `encode_jobs` ADD `progress_eta_seconds` integer;--> statement-breakpoint
