ALTER TABLE `disc_inspections` ADD `settling_baseline_capacity_bytes` integer;--> statement-breakpoint
...
CREATE TABLE `__new_disc_inspections` (
	...
	`settling_baseline_capacity_bytes` integer,
