ALTER TABLE `archive_jobs` ADD `progress_eta_seconds` integer;--> statement-breakpoint
...
INSERT INTO `__new_archive_jobs`(`id`, `archive_request_id`, `disc_inspection_id`, `detected_disc_id`, `original_disc_archive_id`, `attempt_ordinal`, `status`, `priority`, `progress_phase`, `progress_percent`, `progress_bytes`, `last_progress_at`, `claimed_by`, `claim_token`, `claimed_at`, `started_at`, `completed_at`, `error_message`, `failure_detail_version`, `read_failure_stage`, `read_failure_category`, `read_failure_classifier_version`, `read_failure_lba`, `read_failure_requested_block_count`, `read_failure_retry_count`, `read_failure_scsi_status`, `read_failure_host_status`, `read_failure_driver_status`, `read_failure_sense_key`, `read_failure_asc`, `read_failure_ascq`, `created_at`, `updated_at`) SELECT `id`, `archive_request_id`, `disc_inspection_id`, `detected_disc_id`, `original_disc_archive_id`, `attempt_ordinal`, `status`, `priority`, `progress_phase`, `progress_percent`, `progress_bytes`, `last_progress_at`, `claimed_by`, `claim_token`, `claimed_at`, `started_at`, `completed_at`, `error_message`, `failure_detail_version`, `read_failure_stage`, `read_failure_category`, `read_failure_classifier_version`, `read_failure_lba`, `read_failure_requested_block_count`, `read_failure_retry_count`, `read_failure_scsi_status`, `read_failure_host_status`, `read_failure_driver_status`, `read_failure_sense_key`, `read_failure_asc`, `read_failure_ascq`, `created_at`, `updated_at` FROM `archive_jobs`;--> statement-breakpoint
