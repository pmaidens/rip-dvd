ALTER TABLE `original_disc_archives` ADD `boundary_first_excluded_lba` integer;--> statement-breakpoint
ALTER TABLE `original_disc_archives` ADD `boundary_maximum_referenced_lba` integer;--> statement-breakpoint
ALTER TABLE `original_disc_archives` ADD `boundary_read_failure_classifier_version` text;--> statement-breakpoint
ALTER TABLE `original_disc_archives` ADD `boundary_read_failure_scsi_status` integer;--> statement-breakpoint
ALTER TABLE `original_disc_archives` ADD `boundary_read_failure_host_status` integer;--> statement-breakpoint
ALTER TABLE `original_disc_archives` ADD `boundary_read_failure_driver_status` integer;--> statement-breakpoint
ALTER TABLE `original_disc_archives` ADD `boundary_read_failure_sense_response_code` integer;--> statement-breakpoint
ALTER TABLE `original_disc_archives` ADD `boundary_read_failure_sense_key` integer;--> statement-breakpoint
ALTER TABLE `original_disc_archives` ADD `boundary_read_failure_asc` integer;--> statement-breakpoint
ALTER TABLE `original_disc_archives` ADD `boundary_read_failure_ascq` integer;--> statement-breakpoint
...
INSERT INTO `__new_original_disc_archives`(`id`, `detected_disc_id`, `disc_kind`, `archive_format`, `archive_path`, `fingerprint`, `size_bytes`, `boundary_policy_version`, `boundary_reported_size_bytes`, `boundary_published_size_bytes`, `boundary_excluded_sector_count`, `integrity`, `integrity_policy_version`, `bad_sector_count`, `bad_area_count`, `bad_sector_ranges`, `bad_sector_counts_by_title`, `archived_at`, `catalog_reviewed_at`, `catalog_review_outcome`, `legacy_cutover_pending`, `verification_status`, `verification_message`, `verified_at`, `created_at`, `updated_at`) SELECT `id`, `detected_disc_id`, `disc_kind`, `archive_format`, `archive_path`, `fingerprint`, `size_bytes`, `boundary_policy_version`, `boundary_reported_size_bytes`, `boundary_published_size_bytes`, `boundary_excluded_sector_count`, `integrity`, `integrity_policy_version`, `bad_sector_count`, `bad_area_count`, `bad_sector_ranges`, `bad_sector_counts_by_title`, `archived_at`, `catalog_reviewed_at`, `catalog_review_outcome`, `legacy_cutover_pending`, `verification_status`, `verification_message`, `verified_at`, `created_at`, `updated_at` FROM `original_disc_archives`;--> statement-breakpoint
