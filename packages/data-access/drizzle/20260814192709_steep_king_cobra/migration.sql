...
CREATE TABLE `__new_original_disc_archives` (
	...
	CONSTRAINT "original_disc_archives_integrity_evidence_check" CHECK(("integrity" = 'unknown' and "integrity_policy_version" is null and "bad_sector_count" is null and "bad_area_count" is null and "bad_sector_ranges" is null) or ("integrity" = 'clean_read' and "integrity_policy_version" is not null and "bad_sector_count" is not null and "bad_area_count" is not null and "bad_sector_ranges" is not null and length("integrity_policy_version") between 1 and 128 and "bad_sector_count" = 0 and "bad_area_count" = 0 and json("bad_sector_ranges") = json('[]')) or ("integrity" = 'watchable_salvage' and "integrity_policy_version" is not null and "bad_sector_count" is not null and "bad_area_count" is not null and "bad_sector_ranges" is not null and length("integrity_policy_version") between 1 and 128 and "bad_sector_count" > 0 and "bad_area_count" > 0 and json_valid("bad_sector_ranges") and json_type("bad_sector_ranges") = 'array')),
