ALTER TABLE `encode_jobs` ADD `predecessor_encode_job_id` text REFERENCES encode_jobs(id) ON DELETE RESTRICT;--> statement-breakpoint
PRAGMA foreign_keys=OFF;--> statement-breakpoint
CREATE TABLE `__new_encode_jobs` (
	`id` text PRIMARY KEY,
	`predecessor_encode_job_id` text,
	`corrected_publication_admitted` integer DEFAULT false NOT NULL,
	...
	CONSTRAINT "encode_jobs_corrected_publication_admission_check" CHECK("corrected_publication_admitted" = 0 or "predecessor_encode_job_id" is not null),
