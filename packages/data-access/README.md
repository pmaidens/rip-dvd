...
single isolated title-VOB payload error passes bounded DVD-aware title playback
validation, is published as `watchable_salvage` with the versioned acceptance
policy and its normalized, bounded bad-sector ranges. Failure and
