...
export const archiveJobs = sqliteTable(
  ...
  (table) => [
    ...
    check(
      ...
      sql`${table.readFailureCategory} is null or ${table.readFailureCategory} = 'unknown' or (${table.readFailureCategory} = 'not_ready' and ${table.readFailureScsiStatus} = 2 and ${table.readFailureHostStatus} = 0 and ${table.readFailureDriverStatus} in (0, 8) and ${table.readFailureSenseKey} = 2 and ${table.readFailureAsc} is not null and ${table.readFailureAscq} is not null) or (${table.readFailureCategory} = 'unit_attention' and ${table.readFailureScsiStatus} = 2 and ${table.readFailureHostStatus} = 0 and ${table.readFailureDriverStatus} in (0, 8) and ${table.readFailureSenseKey} = 6 and ${table.readFailureAsc} is not null and ${table.readFailureAscq} is not null) or (${table.readFailureCategory} = 'hardware_error' and ${table.readFailureScsiStatus} = 2 and ${table.readFailureHostStatus} = 0 and ${table.readFailureDriverStatus} in (0, 8) and ${table.readFailureSenseKey} = 4 and ${table.readFailureAsc} is not null and ${table.readFailureAscq} is not null) or (${table.readFailureCategory} = 'transport_error' and ${table.readFailureScsiStatus} is not null and ${table.readFailureHostStatus} is not null and ${table.readFailureDriverStatus} is not null and ((${table.readFailureHostStatus} between 1 and 18) or ${table.readFailureHostStatus} = 20 or (${table.readFailureHostStatus} = 0 and ${table.readFailureDriverStatus} in (1, 2, 4, 6)))) or (${table.readFailureCategory} = 'protection_error' and ${table.readFailureScsiStatus} = 2 and ${table.readFailureHostStatus} = 0 and ${table.readFailureDriverStatus} in (0, 8) and ${table.readFailureAsc} is not null and ${table.readFailureAscq} is not null and (${table.readFailureSenseKey} = 7 or (${table.readFailureSenseKey} = 5 and ${table.readFailureAsc} = 111 and ${table.readFailureAscq} between 0 and 5)))`,
    ),
  ],
);
