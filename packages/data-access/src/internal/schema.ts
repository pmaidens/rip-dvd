...
export const discInspections = sqliteTable(
  ...
  (table) => [
    ...
    index("disc_inspections_drive_updated_idx").on(
      table.opticalDriveId, table.updatedAt, table.id,
    ),
    index("disc_inspections_disc_updated_idx").on(
      table.detectedDiscId, table.updatedAt, table.id,
    ),
...
export const filesystemVerificationRuns = sqliteTable(
  ...
  {
    id: text("id").$type<FilesystemVerificationRunId>().notNull().primaryKey(),
    target: text("target").$type<FilesystemVerificationTarget>().notNull(),
    targetId: text("target_id").$type<OriginalDiscArchiveId | EncodeJobId>().notNull(),
    ...
    claimToken: text("claim_token").$type<FilesystemVerificationClaimToken>(),
...
export const originalDiscArchives = sqliteTable(
  ...
  (table) => [
    ...
    check(
      ...
      sql`(${table.boundaryPolicyVersion} is null and ${table.boundaryReportedSizeBytes} is null and ${table.boundaryPublishedSizeBytes} is null and ${table.boundaryExcludedSectorCount} is null and ${table.boundaryFirstExcludedLba} is null and ${table.boundaryMaximumReferencedLba} is null and ${table.boundaryReadFailureClassifierVersion} is null and ${table.boundaryReadFailureScsiStatus} is null and ${table.boundaryReadFailureHostStatus} is null and ${table.boundaryReadFailureDriverStatus} is null and ${table.boundaryReadFailureSenseResponseCode} is null and ${table.boundaryReadFailureSenseKey} is null and ${table.boundaryReadFailureAsc} is null and ${table.boundaryReadFailureAscq} is null) or (${table.discKind} = 'dvd' and typeof(${table.boundaryReportedSizeBytes}) = 'integer' and ${table.boundaryReportedSizeBytes} between 1 and 9000000000 and typeof(${table.sizeBytes}) = 'integer' and typeof(${table.boundaryPublishedSizeBytes}) = 'integer' and ${table.boundaryPublishedSizeBytes} = ${table.sizeBytes} and typeof(${table.boundaryExcludedSectorCount}) = 'integer' and ((${table.boundaryPolicyVersion} = 'dvd-archive-boundary-v1' and ${table.boundaryPublishedSizeBytes} = ${table.boundaryReportedSizeBytes} and ${table.boundaryExcludedSectorCount} = 0 and ${table.boundaryFirstExcludedLba} is null and ${table.boundaryMaximumReferencedLba} is null and ${table.boundaryReadFailureClassifierVersion} is null and ${table.boundaryReadFailureScsiStatus} is null and ${table.boundaryReadFailureHostStatus} is null and ${table.boundaryReadFailureDriverStatus} is null and ${table.boundaryReadFailureSenseResponseCode} is null and ${table.boundaryReadFailureSenseKey} is null and ${table.boundaryReadFailureAsc} is null and ${table.boundaryReadFailureAscq} is null) or (${table.boundaryPolicyVersion} = 'dvd-archive-boundary-v2' and ${table.boundaryReportedSizeBytes} % 2048 = 0 and ${table.boundaryPublishedSizeBytes} = ${table.boundaryReportedSizeBytes} and ${table.boundaryExcludedSectorCount} = 0 and typeof(${table.boundaryFirstExcludedLba}) = 'integer' and ${table.boundaryFirstExcludedLba} = ${table.boundaryPublishedSizeBytes} / 2048 and ${table.boundaryMaximumReferencedLba} is null and typeof(${table.boundaryReadFailureClassifierVersion}) = 'text' and length(${table.boundaryReadFailureClassifierVersion}) between 1 and 128 and typeof(${table.boundaryReadFailureScsiStatus}) = 'integer' and ${table.boundaryReadFailureScsiStatus} between 0 and 255 and (${table.boundaryReadFailureScsiStatus} & 254) = 2 and typeof(${table.boundaryReadFailureHostStatus}) = 'integer' and ${table.boundaryReadFailureHostStatus} = 0 and typeof(${table.boundaryReadFailureDriverStatus}) = 'integer' and ${table.boundaryReadFailureDriverStatus} between 0 and 65535 and (${table.boundaryReadFailureDriverStatus} & 15) in (0, 8) and typeof(${table.boundaryReadFailureSenseResponseCode}) = 'integer' and ${table.boundaryReadFailureSenseResponseCode} in (112, 114) and typeof(${table.boundaryReadFailureSenseKey}) = 'integer' and ${table.boundaryReadFailureSenseKey} = 5 and typeof(${table.boundaryReadFailureAsc}) = 'integer' and ${table.boundaryReadFailureAsc} = 33 and typeof(${table.boundaryReadFailureAscq}) = 'integer' and ${table.boundaryReadFailureAscq} = 0) or (${table.boundaryPolicyVersion} = 'dvd-archive-boundary-v1' and ${table.boundaryReportedSizeBytes} % 2048 = 0 and ${table.boundaryPublishedSizeBytes} % 2048 = 0 and ${table.boundaryPublishedSizeBytes} between 2048 and ${table.boundaryReportedSizeBytes} - 2048 and ${table.boundaryExcludedSectorCount} = (${table.boundaryReportedSizeBytes} - ${table.boundaryPublishedSizeBytes}) / 2048 and typeof(${table.boundaryFirstExcludedLba}) = 'integer' and ${table.boundaryFirstExcludedLba} = ${table.boundaryPublishedSizeBytes} / 2048 and typeof(${table.boundaryMaximumReferencedLba}) = 'integer' and ${table.boundaryMaximumReferencedLba} between 0 and ${table.boundaryFirstExcludedLba} - 1 and typeof(${table.boundaryReadFailureClassifierVersion}) = 'text' and length(${table.boundaryReadFailureClassifierVersion}) between 1 and 128 and typeof(${table.boundaryReadFailureScsiStatus}) = 'integer' and ${table.boundaryReadFailureScsiStatus} between 0 and 255 and (${table.boundaryReadFailureScsiStatus} & 254) = 2 and typeof(${table.boundaryReadFailureHostStatus}) = 'integer' and ${table.boundaryReadFailureHostStatus} = 0 and typeof(${table.boundaryReadFailureDriverStatus}) = 'integer' and ${table.boundaryReadFailureDriverStatus} between 0 and 65535 and (${table.boundaryReadFailureDriverStatus} & 15) in (0, 8) and typeof(${table.boundaryReadFailureSenseResponseCode}) = 'integer' and ${table.boundaryReadFailureSenseResponseCode} in (112, 114) and typeof(${table.boundaryReadFailureSenseKey}) = 'integer' and ${table.boundaryReadFailureSenseKey} = 5 and typeof(${table.boundaryReadFailureAsc}) = 'integer' and ${table.boundaryReadFailureAsc} = 33 and typeof(${table.boundaryReadFailureAscq}) = 'integer' and ${table.boundaryReadFailureAscq} = 0)))`,
    ),
    check(
      "original_disc_archives_boundary_policy_version_check",
      sql`(${table.boundaryPolicyVersion} is null and ${table.boundaryReportedSizeBytes} is null) or (typeof(${table.boundaryPolicyVersion}) = 'text' and ${table.boundaryPolicyVersion} in ('dvd-archive-boundary-v1', 'dvd-archive-boundary-v2') and ${table.boundaryReportedSizeBytes} is not null)`,
    ),
    check(
...
export const archiveJobs = sqliteTable(
  ...
  (table) => [
    ...
    index("archive_jobs_inspection_created_idx").on(
      table.discInspectionId, table.createdAt, table.id,
    ),
    index("archive_jobs_archive_created_idx").on(
      table.originalDiscArchiveId, table.createdAt, table.id,
    ),
    index("archive_jobs_disc_created_idx").on(
      table.detectedDiscId, table.createdAt, table.id,
    ),
    check(
...
export const encodeJobs = sqliteTable(
  ...
  (table) => [
    ...
    index("encode_jobs_selection_created_idx").on(
      table.discSelectionId, table.createdAt, table.id,
    ),
...
export const encodeJobFailureReports = sqliteTable(
  ...
  (table) => [
    ...
    check(
      ...
      sql`${table.reasonCode} in ('input_unavailable', 'invalid_configuration', 'output_conflict', 'unsafe_output_state', 'command_failed', 'command_timeout', 'output_validation_failed', 'unknown_failure') or (${table.reasonCode} = 'cleanup_failed' and ${table.phase} = 'cleanup' and ${table.retryability} = 'after_action') or (${table.reasonCode} = 'publication_failed' and ${table.phase} = 'publication' and ${table.retryability} = 'after_action') or (${table.reasonCode} = 'lease_expired' and ${table.retryability} = 'after_action' and ((${table.context} = 'publication_cleanup' and ${table.phase} in ('publication', 'cleanup')) or (${table.context} = 'job_claim' and ${table.phase} in ('preparation', 'scanning', 'previewing', 'encoding', 'validation', 'publication')))) or (${table.reasonCode} = 'worker_interrupted' and ${table.retryability} = 'after_action' and ((${table.context} = 'publication_completion' and ${table.phase} = 'publication') or (${table.context} = 'worker_shutdown' and ${table.phase} in ('preparation', 'scanning', 'previewing', 'encoding', 'validation', 'publication')))) or (${table.reasonCode} = 'publication_recovery_failed' and ${table.phase} = 'recovery' and ${table.retryability} = 'after_action')`,
    ),
